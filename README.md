...
1. KEY CHARACTERISTICS
    ...
    2. Patch notes (news of updates and changes to character/weapons/map)
    3. Event (Add information about the featured events) 
...
2. GOALS
    ...
    2. Have a list of agents that has information about their character and aswell as their guides and tricks
    3. Make it look nice and simple
    4. Simple navigation and add some interation  
    5. Find a layout of a map, if not, see if I can try to make it
    6. Gather information about the events either upcoming or bring back 
...
3. MILESTONES
    ...
    3. Display the guides in its own section and it will have videos, a map, and agent guide 
    4. Add sound effects when clicking a button or having little soft music in the background 
    5. Display a video either on the background or under title 
4. METRICS
    1. ALL METRICS
       1. How many people view the agent 
       2. How many people view the guides 
       3. How many people enter the website 
       4. How many people view the tricks
       5. How many people view the event section
...
<img width="750" alt="Screen Shot 2022-07-26 at 10 31 57 AM" src="https://user-images.githubusercontent.com/108141836/181034314-52b4791a-868a-4986-a964-489216fab934.png">
...
1. Mockup design 1
    ...
    <img width="772" alt="Screen Shot 2022-07-26 at 10 32 35 AM" src="https://user-images.githubusercontent.com/108141836/181034351-693610b2-3d9f-4cce-bb56-1f611e577b4a.png">
...
2. Mockup design 2
    ...
    <img width="770" alt="Screen Shot 2022-07-26 at 10 32 45 AM" src="https://user-images.githubusercontent.com/108141836/181034380-71111c69-c318-4242-a301-04fffca80092.png">
